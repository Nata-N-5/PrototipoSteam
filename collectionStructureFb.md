Estructura Base de Datos en Firebase 

En este documento se explica la organización de la base de datos NoSQL en Firebase utilizada en el prototipo del proyecto final, basada en la base de datos Steam desarrollada previamente.
El objetivo principal es almacenar la información dentro de la base no relacional proporcionada por Firebase.

A diferencia de MySQL que gestiona datos estructurados mediante tablas, relaciones y claves foráneas, Firebase permite guardar la información de manera más ágil y flexible.
Para este prototipo se almacenaron 10 registros con el fin de implementar una paginación simple. En el archivo firePage.js se estableció un límite que permite visualizar solo 4 registros por página, correspondientes a la primera página de los datos almacenados en Firebase.


Ruta del archivo: node routes/firePage.js
(Ejemplo de la paginación aplicada a la colección “game”, visualizado en la consola).
